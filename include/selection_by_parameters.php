<div class="catalog_filter_block">
	<form class="filter_parametrs" action="./filter_parametrs.php" method="GET" id="filter_parameters_form">
		<div class="filter_parametrs_i" param="brand">
			...
			<div class="filter_parametrs_i_checkbox checkbox">
				<ul>
					<?php 
						$query = "SELECT * FROM brand WHERE category='winter_transport' && type_transport='Сани'";
