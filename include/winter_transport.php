			...
			<div class="sledge_product">
				...
				<div class="product_block">
					...
					<?php 
						...
						$query = "SELECT * FROM table_winter_transport";
									...
									<div class="row">
									  <div class="col-xs-6 col-md-3">
									    <a href="#" class="thumbnail">
									      <img src="/upload_imges/'.$row["image"].'" alt="...">
									    </a>
									    <div class="caption">
											<h3>'.$row["title"].'</h3>
											<p>'.$row["price"].'</p>
											<p><a href="#" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-shopping-cart"></span></a></p>
										</div>
									  </div>
									</div>
