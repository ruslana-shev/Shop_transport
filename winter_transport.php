...
<main>
	<div class="container">
		...
		<!-- 		<div class="container"> -->
						<div class="row">
							<?php 
								$query = "SELECT * FROM table_all_products WHERE visible='1' && type_transport='winter_transport' ORDER BY $sorting";
								...
								if ($rows > 0) {
									...
									do {
										...
										// 	$max_width = 200;
										// 	$max_height = 200;
										// 	list($width, $height) = getimagesize($img_pach);
										// 	$ratiow = $max_width/$width;
										// 	$ratioh = $max_height/$height;
										// 	$retio = min($ratioh, $ratiow);
										// 	$width = intval($retio, $width);
										// 	$height = intval($retio, $height);
										// }	else{
